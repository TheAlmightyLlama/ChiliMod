...
public class DamageSourceKitchenKnife extends DamageSource{

	public DamageSourceKitchenKnife(String id) {
		super(id);
	}

	public static DamageSource causeSwordDamage(Entity par0Entity, Entity par1Entity)
	{
		return (new EntityDamageSourceIndirect("kitchenknifedmg", par0Entity, par1Entity));
	}
